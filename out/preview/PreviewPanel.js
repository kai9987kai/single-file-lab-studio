...
class PreviewPanel {
    ...
    static createOrShow(fileUri) {
        const column = vscode.ViewColumn.Beside;
        if (PreviewPanel.currentPanel) {
            PreviewPanel.currentPanel._panel.reveal(column);
            return;
        }
        const panel = vscode.window.createWebviewPanel('labPreview', `Lab Preview: ${path.basename(fileUri.fsPath)}`, column, {
            enableScripts: true,
    ...
    _setupWatcher() {
        ...
        this._watcher = vscode.workspace.createFileSystemWatcher(new vscode.RelativePattern(vscode.Uri.file(path.dirname(this._fileUri.fsPath)), path.basename(this._fileUri.fsPath)));
