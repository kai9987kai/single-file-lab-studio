...
export function generateBaseApp(options: AppOptions): string {
...
function generateCSS(dark: boolean): string {
...
function generatePresetManagerHTML(): string {
...
function generateExportButtonsHTML(): string {
...
function generatePresetManagerJS(): string {
  return `
  // ─── Preset Manager ─────────────────────────────────────
...
function generateExportJS(): string {
  return `
  // ─── Export Utilities ────────────────────────────────────
